...
function dePalabrasAFrase(palabras) {
  ...
  // Tu código:
  var palabras = ["Hola", "Tengo", "45", "Años", "!"];
...
for ( var i=0 ; i < resultadosTest.length; i ++);{
  resultado = resultados + resultadosTest[i];
  var prom = resultado / resultadosTest.length;
  return prom;
}
...
function mesesDelAño(array) {
  ...
  // Tu código:
  var array = array ["noviembre", "enero", "febrero" , "abril", "marzo", "junio",
  "mayo","agosto","julio","septiembre","diciembre","octubre" ]
  var newarray = newarray [0];
  if (array === "enero" || array === "marzo" || array === "noviembre");{
    var newarray = array.pop("enero" || "marzo" || "noviembre")
    return newarray;
    }
...
function breakStatement(numero) {
  ...
  //la ejecución y devolver: "Se interrumpió la ejecución"
...
function continueStatement(numero) {
  ...
  //siguiente iteración -- Pista: usá el statement 'continue'
  // Tu código:
  var i = 0;
  var array = [0];
